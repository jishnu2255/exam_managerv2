						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <?php
                                                            $dt=date('Y-m-d');
                                                            $selt=mysqli_query($dbcon,"select * from upload_ttable where dt >=$dt");
                                                            if(mysqli_num_rows($selt)>0)
                                                            {
                                                                ?>
                                                            <table class="table table-bordered table-condensed">
                                                                <tr>
                                                                    <td colspan="5"><center><b>UPLOADED TIMETABLE DETAILS</b></center></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>#</td>
                                                                    <td>Exam Title</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    if($rt[2]=="1")
                                                                    {
                                                                        ...
                                                                        echo"Model Exam";
                                                                            ...
                                                                            ?></td>
                                                                    <td><a href="../staff/timetable/<?php echo $rt[3] ?>" target="_BLANK"><span class="fa fa-download"></span></a></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
