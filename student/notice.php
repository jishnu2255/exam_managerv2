						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-md-2">
                                                            <?php
                                            $dt=date('Y-m-d');
                                            $chk=mysqli_query($dbcon,"select * from notice_data where edt >='$dt' order by nid desc");
                                            if(mysqli_num_rows($chk)>0)
                                            {
                                                while($rc=mysqli_fetch_row($chk))
                                                {
                                                 ?>
                                                            <a href="notice.php?nid=<?php echo $rc[0] ?>"><div style="border: 1px solid white; box-shadow: 0px 0px 5px black; padding: 5px;">
                                                                <?php echo $rc[1] ?>
                                                                </div></a>
                                                            <?php
                                                }
                                            ...
                                            ?>
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            {
                                                                $nid=$_GET['nid'];
                                                                $seln=mysqli_query($dbcon,"select * from notice_data where nid='$nid'");
                                                                $rn=mysqli_fetch_row($seln);
                                                                ?>
