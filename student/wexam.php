...
if(isset($_POST['sub']))
{
    ...
    for($i=1;$i<=$c;$i++)
    {
        ...
        {
            $a=$_POST["a$i"];
            $chk=mysqli_query($dbcon,"select * from cxam_ansrkey where id='$a' and qid='$q' and ans='1'");
     ...
     $insans=mysqli_query($dbcon,"INSERT INTO `xam_ans`(`xamid`, `sid`, `qid`, `aid`, `st`) VALUES ('$eid','$uid','$q','$a','$r')");   
    }
    if($insans>0)
    {
        header("location:wexam.php");
    }
}
?>
<!DOCTYPE html>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
                                            <?php
                                            $dt=date('Y-m-d');
                                            $chk=mysqli_query($dbcon,"select * from notice_data where edt >='$dt'")
                                            ?>
                                            <li class="red" style="">
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header">
									...
									<?php echo mysqli_num_rows($chk) ?> Active Notifications
								</li>
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
                                                                            ...
                                                                            ?>
										<li>
											<a href="notice.php?nid=<?php echo $rc[0] ?>">
												<?php echo $rc[1] ?>
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                                            <img class="nav-user-photo" src="stud_pic/nopic.jpg" alt="<?php echo $rdata[6] ?>" />
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<!--<li class="active">
							...
							<span class="menu-text">Write Exam </span>
						</a>
						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-8">                                                            
                                                           ...
                                                           {
                                                               $eid=$_GET['eid'];
                                                               $sele=mysqli_query($dbcon,"select * from xam_data where id='$eid'");
                                                               $re=mysqli_fetch_row($sele);
                                                               ?>
                                                            <form method="post">
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                <tr>
                                                                    <td colspan="3"><center><b><?php echo strtoupper($re[5]) ?></b></center></td>
                                                                </tr>
                                                                <?php
                                                                $selq=mysqli_query($dbcon,"select * from xam_qn where xamid='$eid' order by rand()");
                                                                $i=0;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><b>
                                                                        <?php
                                                                        $selqq=mysqli_query($dbcon,"select * from cxam_qnbank where id='$rq[2]'");
                                                                        $rqq=mysqli_fetch_row($selqq);
                                                                        echo $rqq[4];
                                                                        ?></b>
                                                                        <input type="hidden" name="q<?php echo $i ?>" value="<?php echo $rq[2] ?>" />
                                                                        <?php
                                                                        $selop=mysqli_query($dbcon,"select * from cxam_ansrkey where qid='$rq[2]' order by rand()");
                                                                        while($rop=mysqli_fetch_row($selop))
                                                                        {
                                                                            ?>                                                                        
                                                                        <input type="radio" name="a<?php echo $i ?>" value="<?php echo $rop[0] ?>" /> <?php echo $rop[2] ?><br />
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3">
                                                                        ...
                                                                        <input type="submit" name="sub" value="Submit Examination" class="btn btn-sm btn-danger pull-right" /></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                            <?php
                                                           ...
                                                           {
                                                        $sel1=mysqli_query($dbcon,"select * from xam_data where cid='$cid' and did='$did' and semid='$sem' and xam_dt='".date('Y-m-d')."'");
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-striped">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    $chk1=mysqli_query($dbcon,"select * from xam_ans where xamid='$re[0]' and sid='$uid'");
                                                                    if(mysqli_num_rows($chk1)>0)
                                                                    {
                                                                        ?>
                                                                    <span class="fa fa-arrow-circle-right" style="color: red" title="Exam Completed"></span>
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                    ?>
                                                                    <a href="index.php?eid=<?php echo $re[0] ?>"><span class="fa fa-arrow-circle-right" style="color: green" title="Write Exam"></span></a>
                                                                <?php
                                                                    }
                                                                    ?>
                                                                </td>
