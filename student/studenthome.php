...
if(isset($_POST['sub10']))
{
    ...
    $ins_msg=mysqli_query($dbcon,"INSERT INTO `wall_post`(`id`, `stud_id`, `dt`, `crs`, `dep`, `sem`, `msg`, `tim`, `st`) VALUES ('','$uid','".date('Y-m-d')."','$cid','$did','$sem','$msg','".time()."','1')");
}
if(isset($_GET['delid']))
{
    $del=mysqli_query($dbcon,"update wall_post set st=0 where id='".$_GET['delid']."' and stud_id='$uid'");
    if($del>0)
    {
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                                            <img class="nav-user-photo" src="stud_pic/<?php echo $rdata[16] ?>" alt="<?php echo $rdata[6] ?>" />
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li class="active">
                                                            <b><?php echo $rcrs[1]." ".$rdep[2] ?> :: Academic Year : <?php echo $ay ?></b>
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-striped">
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i ?></td>
                                                                <td><?php echo $re[1] ?></td>
                                                                <td><a href="studenthome.php?eid=<?php echo $re[0] ?>"><span class="fa fa-arrow-circle-right" style="color: green" title="Find My Seats"></span></a></td>
                                                            </tr>
                                                            <?php                                                                
                                                            }
                                                            ?>
                                                        ...
                                                        ?>
                                                          ...
                                                          if(isset($_GET['eid']))
                                                          {
                                                              $eid=$_GET['eid'];
                                                              $adnum=$rdata[7];
                                                              $selxam=mysqli_query($dbcon,"select * from exam_assign where eid='$eid' and crsid='$cid' and depid='$did' and acyr='$ay' order by dt asc");
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                    <td><?php echo $rxam[6] ?></td>
                                                                    <td><?php echo date("d-M-Y",strtotime($rxam[7])) ?></td>
                                                                    <td><?php echo $rxam[8] ?></td>
                                                                    <td>
                                                                        <?php
                                                                        $selrm=mysqli_query($dbcon,"select * from room_assign where eid='$eid' and rolnum='$adnum' and dt='$rxam[7]' and tim='$rxam[8]'");
                                                                        if(mysqli_num_rows($selrm)>0)
                                                                        {
                                                                            $rrm=mysqli_fetch_row($selrm);
                                                                            ?>
                                                                        <span class="label label-success">
                                                                            <?php echo"<b>$rrm[2]</b> | Room No: $rrm[3] Bench No :$rrm[4]"; ?>
                                                                        </span>  
                                                                            <?php
                                                                        }
                                                                        else{
                                                                            ?>
                                                                        <span class="label label-danger">Not Charted</span>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </td>
