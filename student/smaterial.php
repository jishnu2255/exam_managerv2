...
{
    $sem=$_POST['sem'];
    header("location:smaterial.php?sem=$sem");
}
?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            {
                                                                $sem=$_GET['sem'];
                                                                $selm1=mysqli_query($dbcon,"select * from s_material where crs='$cid' and dep='$did' and sem='$sem' and st='1'");
                                                            ...
                                                            $selm=mysqli_query($dbcon,"select distinct sem from s_material where crs='$cid' and dep='$did' and st='1'");
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                                                ...
                                                                <?php
                                                                $selm1=mysqli_query($dbcon,"select * from s_material where crs='$cid' and dep='$did' and sem='$rm[0]' and st='1'");
                                                                if(mysqli_num_rows($selm1)>0)
                                                                {
                                                                    $i=0;
                                                                    while($rm1=mysqli_fetch_row($selm1))
