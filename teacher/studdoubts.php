...
{
    $ans=$_POST['ans'];
    $insans=mysqli_query($dbcon,"INSERT INTO `dbt_ans`(`dbtid`, `ans`, `dt`, `ansby`) VALUES ('".$_GET['qid']."','$ans','".date('Y--d')."','$uid')");
    $up=mysqli_query($dbcon,"update stud_doubt set st='1' where id='".$_GET['qid']."'");
    if($up>0)
    {
        header("location:studdoubts.php?qid=".$_GET['qid']);
    }
}
?>
<!DOCTYPE html>
					...
					<div class="page-content">
						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">                                                        
                                                        <div class="col-md-6">
                                                            <?php
                                                            $dbt1=mysqli_query($dbcon,"select * from stud_doubt where stfid='$uid' order by st asc");
                                                            if(mysqli_num_rows($dbt1)>0)
                                                            {
                                                                ?>
                                                            <table class="table table-bordered table-condensed table-responsive">
                                                                ...
                                                                <?php
                                                                $i=0;
                                                                while($rd1=mysqli_fetch_row($dbt1))
                                                                {
                                                                    $i++;
                                                                    ?>
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                        ...
                                                                        By:
                                                                        <?php
                                                                        $st=mysqli_query($dbcon,"select * from student_data where admnum='$rd1[1]'");
                                                                                $rst=mysqli_fetch_row($st);
                                                                                echo $rst[6];
                                                                        ?>
                                                                        </span>
                                                                        <div style="float: right;"><?php echo date("d-M-Y",strtotime($rd1[3])) ?></div><br />
                                                                        <?php echo $rd1[4] ?>                                                                    
                                                                    </td>
                                                                    <td style="width: 15%;">
                                                                        <a href="studdoubts.php?qid=<?php echo $rd1[0] ?>">
                                                                        <span class="label label-danger">
                                                                        <?php
                                                                        $ans1=mysqli_query($dbcon,"select * from dbt_ans where dbtid='$rd1[0]'");
                                                                        echo mysqli_num_rows($ans1)." Answers"
                                                                        ?>
                                                                        </span>
                                                                        </a>
                                                                    </td>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            {
                                                                $qid=$_GET['qid'];
                                                                $selq=mysqli_query($dbcon,"select * from stud_doubt where id='$qid'");
                                                                $rqn=mysqli_fetch_row($selq);
                                                                echo "<h3>".$rqn[4]."</h3>";
                                                                                                                        
                                                            ?>
                                                            <form method="post">
                                                                <textarea name="ans" class="form-control"></textarea>
                                                                <input type="submit" name="sub" value="POST NOW" class="btn btn-sm btn-success pull-right" />
                                                            </form><br /><br />
                                                            <h5><b>AVAILABLE ANSWERS</b></h5>
                                                            <?php
                                                            $ans1=mysqli_query($dbcon,"select * from dbt_ans where dbtid='".$_GET['qid']."'");
