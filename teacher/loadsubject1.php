...
if(mysqli_num_rows($sel_subj)>0)
{
    ...
    <tr>
        ...
        <td><a href="pquestions.php?c=<?php echo $c ?>&d=<?php echo $d ?>&s=<?php echo $s ?>&subid=<?php echo $r_sub[5] ?>" class="label label-danger pull-right" title="Upload Study Material"><span class="fa fa-upload"></span></a></td>
    </tr>
<?php       
    }
    ?>    
