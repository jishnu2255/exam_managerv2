...
if(isset($_POST['ad_qn']))
{
    ...
    $subid=$_GET['subid'];
    $ch=$_GET['ch'];
    $ins=mysqli_query($dbcon,"INSERT INTO `cxam_qnbank`(`cid`, `did`, `subid`, `qn`, `qn_by`, `sem`, `chap`) VALUES ('$cid','$did','$subid','$qn','$uid','$sem','$ch')");
    ...
    foreach($op as $v)
    {
        ...
        $insop=mysqli_query($dbcon,"INSERT INTO `cxam_ansrkey`(`qid`, `opt`, `ans`) VALUES ('$insid','$v','$key')");
    }
    if($insop>0)
    {
        header("location:addquestion.php?c=$cid&d=$did&s=$sid&subid=$subid&ch=$ch");
    }
}
?>
<!DOCTYPE html>
						...
						<div class="row">
                                                       ...
                                                       $subid=$_GET['subid'];
                                                        ...
                                                        <table class="table table-bordered table-hover table-responsive">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                       <?php
                                                                       $chk=mysqli_query($dbcon,"select * from cxam_qnbank where subid='".$_GET['subid']."' and chap='$rc[0]'");
                                                                       echo mysqli_num_rows($chk);
                                                                       ?>
                                                                </td>
                                                                <td><a href="addquestion.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>&subid=<?php echo $_GET['subid'] ?>&ch=<?php echo $rc[0] ?>"><span class="fa fa-plus-square"></span></a></td>
                                                            </tr>
                                                            <?php
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        if(isset($_GET['ch']))
                                                        {
                                                            ...
                                                            $selch1=mysqli_query($dbcon,"select * from chapter_data where id='$ch'");
                                                            $rch1=mysqli_fetch_row($selch1);
                                                            ?>
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-striped">
                                                            <tr>
                                                               <td colspan="2"><center><b>ADD QUESTIONS <br /> <?php echo $rc[1] ?>-<?php echo $rd[2] ?>-<?php echo $rsn[4] ?>-<?php echo $rch1[2] ?></b></center></td>
                                                            </tr>
                                                            <tr>                        
                                                                <td colspan="2">Type Question
                                                                  <textarea id="editor" name="qn" required="required"></textarea>  
                                                                </td>
                                                            </tr>
                                                             <script>
                                                initSample();
                                                            ...
                                                            <tr>
                                                                <td>Option 1</td>
                                                                <td>
                                                                    <input type="text" name="op[]" placeholder="must be answer" class="form-control-static" style="width: 100%" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Option 2</td>
                                                                <td>
                                                                    <input type="text" name="op[]" placeholder="Any Option" class="form-control-static" style="width: 100%" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Option 3</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                            <center>
                                                                <input type="submit" name="ad_qn" value="ADD QUESTION" class="btn btn-sm btn-success" />
                                                            </center>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <?php
                                                        $selqn=mysqli_query($dbcon,"select * from cxam_qnbank where subid='".$_GET['subid']."' and chap='".$_GET['ch']."'");
                                                        if(mysqli_num_rows($selqn)>0)
                                                        {
                                                            while($rq=mysqli_fetch_row($selqn))
                                                            {
                                                                echo $rq[4];
                                                                echo"<hr />";
                                                            }
