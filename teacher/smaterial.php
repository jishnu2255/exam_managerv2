...
if(isset($_POST['sub1']))
{
    ...
    if(move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\smaterial\\$fn"))
    {
        $ins_sm=mysqli_query($dbcon,"INSERT INTO `s_material`(`crs`, `dep`, `sem`, `subid`, `titl`, `descr`, `fil`, `up_by`, `st`) VALUES ('$c','$d','$sem','$subid','$t','$descr','$fn','$uid','1')");
        if($ins_sm>0)
        {
            header("location:smaterial.php?c=$c&d=$d&s=$sem&subid=$subid");
        }
    }
}
?>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            ?>
                ...
                {                    
                    ...
                    xmlhttp.open("GET", "loadsubject.php?s=" + s+"&c="+c+"&d="+d, true);
                    xmlhttp.send();                                                            
                }
                </script>
                <tr>
            ...
            if(isset($_GET['subid']))
            {
            $selm=mysqli_query($dbcon,"select * from s_material where subid='".$_GET['subid']."' and st='1'");
            ...
            <table class="table table-bordered table-condensed table-hover table-responsive">
                ...
                <tr>
                    ...
                    <td><a target="_BLANK" href="smaterial/<?php echo $rm[7] ?>" class="label label-warning"><span class="fa fa-download"></span></a></td>
                </tr>
                <?php
                }
                ?>
