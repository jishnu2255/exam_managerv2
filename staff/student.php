...
if(isset($_POST['sub1']))
{
    ...
    $regn=$_POST['regn'];
    $pas=$_POST['pas'];
    $ins_st=mysqli_query($dbcon,"INSERT INTO `student_data`(`id`, `crs`, `dep`, `sem`, `ay`, `active_st`, `nme`, `admnum`, `regnum`, `addr`, `dob`, `con`, `fatrnme`, `mob`, `bldgrp`, `pic`, `st`, `gndr`) VALUES ('','$c','$d','$s','$ay','1','$sn','$regn','nil','nil','','nil','nil','0','nil','0','0','0')");
    if($ins_st>0)
    {
                                                ...
                                                <div class="row">                                                    
                                                        <div class="col-lg-12">
                                                           ...
                                                           if(isset($_GET['c']))
                                                           {
                                                               ...
                                                               $sel_st=mysqli_query($dbcon,"select * from student_data where crs='$c' and dep='$d' and ay='$ay' and active_st='1' order by st asc");
