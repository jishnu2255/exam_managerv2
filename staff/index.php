                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <table class="table table-bordered table-condensed table-hover table-striped">
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i ?></td>
                                                                <td><?php echo $re[1] ?></td>
                                                                <td><a href="index.php?eid=<?php echo $re[0] ?>"><span class="fa fa-arrow-circle-right" style="color: green" title="ASSIGN EXAMINATION"></span></a></td>
                                                            </tr>
                                                            <?php                                                                
                                                            }
                                                            ?>
                                                           ...
                                                           <center>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div id="dd<?php echo $z ?>" style="display: none">
                                                                        <input type="date" class="form-control" onchange="chngdt(this.value,'<?php echo $z ?>','<?php echo $rxam[0] ?>')" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div id="t<?php echo $z ?>"><?php echo $rxam[8] ?></div>
                                                                    <div id="tt<?php echo $z ?>" style="display: none">
                                                                        <input type="time" class="form-control" onblur="chngtim(this.value,'<?php echo $z ?>','<?php echo $rxam[0] ?>')" />
                                                                    </div>
                                                                </td>
                                                                <td><span class="fa fa-edit" style="color: orangered;" onclick="shoedit('<?php echo $z ?>')"></span></td>
                                                            </tr>
                                                            <?php
                                                            }
                                                            }
