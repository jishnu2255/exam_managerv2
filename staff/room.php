...
if(isset($_POST['sub']))
{
    ...
    $ba=$_POST['ba'];
    $nr=$_POST['nr'];
    $ins=mysqli_query($dbcon,"INSERT INTO `room_data`(`blk_nme`, `rm_nbr`, `bnch`, `nros`) VALUES ('$bn','$rn','$ba','$nr')");
    if($ins>0)
    {
...
{
    $did=$_GET['did'];
    $del=mysqli_query($dbcon,"delete from room_data where id='$did'");
    if($del>0)
    {
        header("location:room.php");
    }
...
if(isset($_POST['sub1']))
{
    ...
    $ba=$_POST['ba1'];
    $nr=$_POST['nr1'];
    $ins=mysqli_query($dbcon,"update `room_data` set `blk_nme` ='$bn', `rm_nbr`='$rn', `bnch`='$ba', `nros`='$nr' where id='".$_GET['edit']."'");
    if($ins>0)
    {
        header("location:room.php");
    }
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-md-6">
                                                            <form method="post">
                                                                ...
                                                                if(isset($_GET['edit']))
                                                                {
                                                                    $sel1=mysqli_query($dbcon,"select * from room_data where id='".$_GET['edit']."'");
                                                                    $r1=mysqli_fetch_row($sel1);
                                                                    ?>
                                                                <table class="table table-bordered table-condensed table-hover table-striped">
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center><b>EDIT ROOM DETAILS</b></center>
                                                            </td>
                                                            </tr>
                                                                <tr>
                                                                    <td>Block Name</td>
                                                                    <td><input type="text" name="bn1" value="<?php echo $r1[1] ?>" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Room Number</td>
                                                                    <td><input type="text" name="rn1" value="<?php echo $r1[2] ?>" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Bench Available</td>
                                                                    <td><input type="text" name="ba1" value="<?php echo $r1[3] ?>" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>No of Rows</td>
                                                                    <td><input type="text" name="nr1" class="form-control" value="<?php echo $r1[4] ?>" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center>
                                                                    <input type="submit" name="sub1" value="EDIT ROOM DETAILS" class="btn btn-sm btn-primary" />
                                                                </center>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center><b>ADD ROOM DETAILS</b></center>
                                                            </td>
                                                            </tr>
                                                                <tr>
                                                                    <td>Block Name</td>
                                                                    <td><input type="text" name="bn" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Room Number</td>
                                                                ...
                                                                <tr>
                                                                    <td>Bench Available</td>
                                                                    <td><input type="text" name="ba" class="form-control" /></td>
                                                                </tr>
                                                                 <tr>
                                                                    <td>No of Rows</td>
                                                                    <td><input type="text" name="nr" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center>
                                                                    <input type="submit" name="sub" value="ADD ROOM" class="btn btn-sm btn-primary" />
                                                                </center>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <div class="col-md-6">
                                                            <?php
                                                            $sel_r=mysqli_query($dbcon,"select * from room_data");
                                                            if(mysqli_num_rows($sel_r)>0)
                                                            {
                                                                ?>
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                <tr>
                                                                    <td colspan="6"><center><b>AVAILABLE ROOM DETAILS</b></center></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>#</td>
                                                                    <td>Block Name</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rr[4] ?></td>
                                                                    <td>
                                                                        <a href="room.php?did=<?php echo $rr[0] ?>"><span class="fa fa-trash" style="color: red;"></span></a> | 
                                                                        <a href="room.php?edit=<?php echo $rr[0] ?>"><span class="fa fa-edit" style="color: blue;"></span></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                }
