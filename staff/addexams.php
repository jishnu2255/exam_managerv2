...
if(isset($_POST['sub']))
{
    ...
    $mrk=$_POST['mrk'];
    $sec=$_POST['sec'];
    $insq=mysqli_query($dbcon,"INSERT INTO `xam_data`(`cid`, `did`, `semid`, `subid`, `xam_tit`, `xam_dt`, `tot_mrk`, `tot_sec`, `ad_dt`, `st`) VALUES ('$c','$d','$s','$subid','$et','$dt','$mrk','$sec','".date('Y-m-d')."','1')");
    if($insq>0)
    {
        header("location:addexams.php?c=$c&d=$d&s=$s&subid=$subid");
    }
}
if(isset($_POST['sub5']))
{
    ...
    $qd=$_POST['qd'];
    $qw=$_POST['qw'];
    $ins=mysqli_query($dbcon,"INSERT INTO `xam_qn`(`xamid`, `sec`, `mrk`, `qtyp`, `totq`, `ansq`) VALUES ('$xid','$sec1','$mrk1','$qp','$qd','$qw')");
    if($ins>0)
    {
        header("location:addexams.php?c=$c&d=$d&s=$s&subid=$subid&xamid=$xid&sec=".$_GET['sec']);
    }
}
?>
<!DOCTYPE html>
						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        if(isset($_GET['c']))
                                                        {
                                                            ...
                                                            $sid=$_GET['s'];
                                                            $subid=$_GET['subid'];
                                                            $selc=mysqli_query($dbcon,"select * from crs_info where crsid='$cid'");
                                                            $rc=mysqli_fetch_row($selc);
                                                            $seld=mysqli_query($dbcon,"select * from dep_info where depid='$did' and crsid='$cid'");
                                                            $rd=mysqli_fetch_row($seld);
                                                            $selsn=mysqli_query($dbcon,"select * from syllabus_data where sub_id='$subid' and crsid='$cid' and depid='$did'");
                                                            ...
                                                            <tr>
                                                               <td colspan="2"><center><b>ADD EXAMINATION <br /> <?php echo $rc[1] ?>-<?php echo $rd[2] ?>-<?php echo $rsn[4] ?></b></center></td>
                                                            </tr>
                                                            <tr>                        
                                                                <td>Exam Title</td>
                                                                <td><input type="text" name="et" class="form-control">  
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Exam Date</td>
                                                            ...
                                                            <tr>
                                                                <td>Total Mark</td>
                                                                <td><input type="text" name="mrk" class="form-control" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Total Section</td>
                                                                <td><input type="text" name="sec" class="form-control" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <input type="submit" name="sub" value="CREATE EXAM" class="btn btn-sm btn-danger" />
                                                                </td>
                                                            </tr>
                                                            </table>
                                                            </form>
                                                            ...
                                                            {
                                                                $xid=$_GET['xamid'];
                                                                $selxdata=mysqli_query($dbcon,"select * from xam_data where id='$xid'");
                                                                $rxdata=mysqli_fetch_row($selxdata);
                                                                $selmk=mysqli_query($dbcon,"select sum(mrk) from xam_qn where xamid='$xid'");
                                                                $rmk=mysqli_fetch_row($selmk);
                                                                $bal=$rxdata[7]-$rmk[0];
                                                                ?>
                                                            <a href="addexams.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>&subid=<?php echo $_GET['subid'] ?>" class="label label-danger pull-right">BACK</a>
                                                            <form method="post">
                                                            <table class="table table-bordered table-responsive">
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center><b><?php echo $rxdata[5] ?></b></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Total Mark</td>
                                                                    <td><input type="text" name="tm1" id="tm1" value="<?php echo $bal ?>" readonly="" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Section</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>Mark</td>
                                                                    <td><input type="text" name="mrk1" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Question Pool</td>
                                                                    <td>
                                                                        <select class="form-control" name="qp">
                                                                            <?php                                                                            
                                                                            $selqp=mysqli_query($dbcon,"select distinct(mrk) from qn_bank where subid='$rxdata[4]'");
                                                                            while($rqp=mysqli_fetch_row($selqp))
                                                                            {
                                                                                ?>
                                                                            <option value="<?php echo $rqp[0] ?>"><?php echo $rqp[0] ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                                    ...
                                                                    <tr>
                                                                        <td>Qn to Display</td>
                                                                        <td><input type="text" name="qd" class="form-control" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Qn to Write</td>
                                                                        <td><input type="text" name="qw" class="form-control" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <?php
                                                                            ...
                                                                            {
                                                                                ?>
                                                                            <div class="btn btn-danger">CANT ADD MORE QUESTIONS</div>
                                                                            <?php
                                                                            }
                                                                            else
                                                                            {
                                                                            ?>
                                                                            <input type="submit" name="sub5" value="ASSIGN SECTION" class="btn btn-sm btn-success" /></td>
                                                                        <?php
                                                                            }
                                                                            ?>
                                                                    </tr>
                                                            ...
                                                            <?php 
                                                            $selx5=mysqli_query($dbcon,"select * from xam_qn where xamid='$xid'");
                                                            if(mysqli_num_rows($selx5)>0)
                                                            {
                                                                ?>
                                                            <table class="table table-bordered table-responsive">
                                                                <tr>
                                                                ...
                                                                <?php
                                                                $i=0;
                                                                while($rx5=mysqli_fetch_row($selx5))
                                                                {
                                                                    $i++;
                                                                    ?>
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                    <td>Section - <?php echo $rx5[2] ?></td>
                                                                    <td><?php echo $rx5[3] ?></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
                                                            ...
                                                            {
                                                            $selxam=mysqli_query($dbcon,"select * from xam_data where subid='$subid' and xam_dt>='".date('Y-m-d')."'");
                                                            ...
                                                            <table class="table table-bordered table-condensed">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php
                                                                    $sec=$rxam[8];
                                                                    $chk=mysqli_query($dbcon,"select * from xam_qn where xamid='$rxam[0]'");
                                                                    $count=mysqli_num_rows($chk);
                                                                    if($count<$sec)
                                                                    {
                                                                        ?>
                                                                        <a href="addexams.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>&subid=<?php echo $_GET['subid'] ?>&xamid=<?php echo $rxam[0] ?>&sec=<?php echo $sec ?>"><span class="fa fa-plus-circle" title="Assign Section"></span></a>
                                                                        <?php
                                                                    }
                                                                    else
                                                                    {
                                                                        ?>
                                                                        <a href="print-qn.php?xamid=<?php echo $rxam[0] ?>" target="_BLANK"><span class="fa fa-eye" title="Generate Question"></span></a>
                                                                        <?php
                                                                    }
                                                                    ?></td>
                                                                </tr>
