				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /.breadcrumb -->
                                                ...
                                                <div style="padding: 5px; margin-left: 15px;"><b>Seat Allocation</b></div>
					</div>
                                               ...
                                               <div class="row">
                                                   <div class="col-xs-12">
                                                       ...
                                                       if(isset($_GET['dt']))
                                                       {
                                                            ...
                                                            $tim=$_GET['ti'];
                                                            $eid=$_GET['eid'];
                                                            $seldata1=mysqli_query($dbcon,"select distinct rumid from room_assign where eid='$eid' and dt='$dt' and tim='$tim'");
                                                            if(mysqli_num_rows($seldata1)>0)
                                                            {
                                                                ?>
                                                           <table class="table table-bordered">
                                                               <?php
                                                               while($rsel1=mysqli_fetch_row($seldata1))
                                                               {
                                                               ?>
                                                               <tr>
                                                                   <td><center><b>ROOM No :<?php echo $rsel1[0] ?></b></center></td>
                                                               </tr>
                                                               <tr>
                                                                   <td>
                                                                       <?php
                                                                       $selr=mysqli_query($dbcon,"select distinct(bnch) from room_assign where rumid='$rsel1[0]' and eid='$eid' and dt='$dt' and tim='$tim' order by id desc");
                                                                       while($rr=mysqli_fetch_row($selr))
                                                                       {
                                                                           ?>
                                                                       <div style="border: 1px solid black; margin-top: 20px; padding: 10px; height: 50px;">
                                                                           <?php
                                                                           $sel5=mysqli_query($dbcon,"select * from room_assign where bnch='$rr[0]' and rumid='$rsel1[0]' and eid='$eid' and dt='$dt' and tim='$tim' order by id desc");
                                                                           $stud="";
                                                                          ...
                                                                          // echo $stud;
                                                                           $stt=  explode(",", $stud);
                                                                           ?>
                                                                           <div style="width: 25%; float: left; border: 1px solid black; margin-right: 100px; padding: 3px; margin-left: 20px;">
                                                                               <div style="float: left;"><?php echo $stt[0] ?></div>
                                                                               <div style="float: right;"><?php echo $stt[1] ?></div>
                                                                           </div>
                                                                           <div style="width: 25%; float: left; border: 1px solid black; margin-right: 100px; padding: 3px;">
                                                                               <div><center><?php echo $stt[2] ?></center></div>
                                                                           </div>
                                                                           <div style="width: 25%; float: left; border: 1px solid black; padding: 3px;">
                                                                               <div style="float: left;"><?php echo $stt[3] ?></div>
                                                                               <div style="float: right;"><?php echo $stt[4] ?></div>
                                                                           </div>
