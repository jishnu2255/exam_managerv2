...
if(isset($_POST['sub']))
{
    ...
    $cid=$_POST['cr'];
    $sem=$_POST['sem'];
    header("location:syllabus.php?c=$cid&d=$did&s=$sem");
}
if(isset($_POST['sub1']))
{
    $crs=$_GET['c'];
    ...
    $up="nodata";
    $nfn="nodata";
    //if(move_uploaded_file($_FILES['f']['tmp_name'], getcwd()."\\syllabus\\$nfn"))
    //{
        $ins_syl=mysqli_query($dbcon,"insert into syllabus_data (`sylid`, `crsid`, `depid`, `sem`, `sub_nme`, `sub_id`, `syl_file`,`sub_mrk`, `st`) values ('','$crs','$dep','$sem','$sn','$sc','$nfn','$sm','1')");
        if($ins_syl>0)
        {
            header("location:syllabus.php?t=1&c=$crs&d=$dep&s=$sem");
        }
    //}
}
if(isset($_POST['sub10']))
{
    ...
    $cn=$_POST['cn10'];
    $subid=$_GET['subid'];
    $ins=mysqli_query($dbcon,"INSERT INTO `chapter_data`(`subid`, `chap_nme`) VALUES ('$subid','$cn')");
    if($ins>0)
    {
        header("location:syllabus.php?c=$crs&d=$dep&s=$sem&subid=$subid");
    }
}
?>
<!DOCTYPE html>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                                            <img class="nav-user-photo" src="../admin/staff_pic/<?php echo $rdata[10] ?>" alt="" />
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /.breadcrumb -->
                                                ...
                                                <div style="padding: 5px; margin-left: 15px;"><b>MANAGE SYLLABUS</b></div>
					</div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <a href="syllabus.php" class="label label-warning pull-right">BACK</a>
                                                                <center><b>ADD SYLLABUS</b></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Course</td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><center>
                                                                        <input type="submit" name="sub1" value="ADD SUBJECT" class="btn btn-sm btn-danger" />
                                                                </center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-striped">
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center><b>CHOOSE DEPARTMENT TO ADD SYLLABUS</b></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Course</td>
                                                                    <td>
                                                                        <select name="cr" class="form-control" onchange="loaddep(this.value)">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><center><input type="submit" name="sub" value="ADD SYLLABUS" class="btn btn-sm btn-danger" /></center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                            <?php
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            {
                                                                $subid=$_GET['subid'];
                                                                $sel_d=mysqli_query($dbcon,"select * from syllabus_data where sylid='$subid'");
                                                                $rd=mysqli_fetch_row($sel_d);
                                                                ?>
                                                                <form method="post">
                                                                    <a href="syllabus.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>" class="label label-danger pull-right">BACK</a>
                                                                <table class="table table-bordered table-condensed table-responsive">
                                                                    <tr>
                                                                        <td colspan="2"><center><b><?php echo strtoupper($rd[4]) ?></b></center></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Chapter Name</td>
                                                                        <td><input type="text" name="cn10" class="form-control"  required="required" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2">
                                                                    <center>
                                                                        <input type="submit" name="sub10" value="ADD NOW" class="btn btn-sm btn-success" />
                                                                    </center>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <?php
                                                                $selch=mysqli_query($dbcon,"select * from chapter_data where subid='$subid'");
                                                                if(mysqli_num_rows($selch)>0)
                                                                {
                                                                    ?>
                                                                <table class="table table-bordered table-hover table-responsive">
                                                                    ...
                                                                    <?php
                                                                    $i=0;
                                                                    while($rc=mysqli_fetch_row($selch))
                                                                    {
                                                                        $i++;
                                                                        ?>
                                                                    <tr>
                                                            ...
                                                            $d=$_GET['d'];
                                                            $s=$_GET['s'];
                                                            $sel_d=mysqli_query($dbcon,"select * from syllabus_data where crsid='$c' and depid='$d' and sem='$s'");
                                                            ...
                                                            $i=0;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rd[4] ?></td>
                                                                    <td><?php echo $rd[5] ?>
                                                                        <a href="syllabus.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>&subid=<?php echo$rd[5] ?>">
                                                                        <span class="fa fa-plus-circle pull-right" title="Add Chapters"></span>
                                                                        </a>
                                                                    </td>                                                                    
