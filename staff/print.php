                                                       ...
                                                       if(isset($_GET['dt']))
                                                       {
                                                           ...
                                                           <table class="table table-bordered">
                                                               ...
                                                               <tr>
                                                                   <td>
                                                                       <?php
                                                                       $selrw=mysqli_query($dbcon,"select * from room_data where rm_nbr='$rsel1[0]'");
                                                                       $rw=mysqli_fetch_row($selrw);
                                                                       $nbnch=$rw[3];
                                                                       $nrow=$rw[4];
                                                                       $cnt=$nbnch/$nrow;
                                                                       $bstart=$nbnch;
                                                                       ...
                                                                       {
                                                                           ?>
                                                                       <div style="border: 1px solid red; margin-top: 20px; padding: 10px; height: 50px;"><center>
                                                                       <?php
                                                                           for($i=1;$i<=$cnt;$i++)
                                                                           {
                                                                               $sel5=mysqli_query($dbcon,"select * from room_assign where bnch='$bstart' and rumid='$rsel1[0]' and eid='$eid' and dt='$dt' and tim='$tim' order by id desc");
                                                                                $stud="";
                                                                               ...
                                                                               // echo $stud;
                                                                                $stt=  explode(",", $stud);
                                                                             ?>
                                                                           <div style="width: <?php echo $per ?>%; float: left; border: 1px solid black; margin-right: 10%; padding: 3px; margin-left: 2%;">
