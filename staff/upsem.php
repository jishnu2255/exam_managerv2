...
if(isset($_POST['sub']))
{
    ...
    $ay=$_POST['ay'];
    $upsem=$_POST['upsem'];
    $up=mysqli_query($dbcon,"update student_data set sem='$upsem' where crs='$crs' and dep='$dep' and ay='$ay'");
    if($up>0)
    {
        header("location:upsem.php");
    }
}
?>
<!DOCTYPE html>
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /.breadcrumb -->
						 ...
						 <div style="padding: 5px; margin-left: 15px;"><b>UPDATE SEMESTER</b></div>
					</div>
                                                    ...
                                                    function loaddep(x)
                                                    {
                                                        ...
                                                        xmlhttp.send();
                                                            ...
                                                            <table class="table table-bordered table-responsive">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <select name="ay" class="form-control" required="required" onchange="loaddata(this.value)">
                                                                ...
                                                                function loaddata(x)
                                                                {
                                                                    ...
                                                                    xmlhttp.onreadystatechange = function() {
                                                                        if (this.readyState == 4 && this.status == 200) {
                                                                            document.getElementById("csem").innerHTML = this.responseText;
                                                                            var sem=this.responseText;
                                                                            document.getElementById("usem").innerHTML =parseInt(sem)+1;
                                                                            document.getElementById("upsem").value =parseInt(sem)+1;
                                                                        }
                                                                    };
                                                                    xmlhttp.open("GET", "upsemstud.php?ay=" + x+"&c="+c+"&d="+d, true);
                                                                    xmlhttp.send();
                                                                }
                                                                </script>
                                                                <tr>
                                                                    <td>
                                                                        Current Semester : <span id="csem"></span>
                                                                    </td>
                                                                    <td>
                                                                        Updated to Semester : <span id="usem"></span>
                                                                        <input type="hidden" name="upsem" id="upsem" /> 
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2"><center>
                                                                        <input type="submit" name="sub" value="Update Semester" class="btn btn-sm btn-success" /> 
                                                                </center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
