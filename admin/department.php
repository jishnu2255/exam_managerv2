...
{    
    $cn=$_POST['cn'];  
     $chk_log=mysqli_query($dbcon,"select * from crs_info where crs_nme='$cn'");
    if(mysqli_num_rows($chk_log)>0)
      {
        header("location:department.php?same=1");
    } 
 else {
        
    
    $ins_crs=mysqli_query($dbcon,"insert into crs_info (`crsid`, `crs_nme`, `st`) values('','$cn','1')");
    if($ins_crs>0)
    {
...
if(isset($_POST['sub1']))
{
    ...
    $up_crs=mysqli_query($dbcon,"update crs_info set crs_nme='$cn' where crsid='".$_GET['cid']."'");
    if($up_crs>0)
    {
...
{
    $dep=$_POST['dep'];
     // $chk_log=mysqli_query($dbcon,"select * from dep_info where dep_nme='$dep'");
    //if(mysqli_num_rows($chk_log)>0)
      //{
       // header("location:department.php?same1=1");
   // } 
 //else {
        
    $ins_dep=mysqli_query($dbcon,"insert into dep_info (`depid`, `crsid`, `dep_nme`, `st`) values ('','".$_GET['cid']."','$dep','1')");
    
    if($ins_dep>0)
    {
        header("location:department.php?edit=2&cid=".$_GET['cid']."&cn=".$_GET['cn']);
    }
 //}
}
if(isset($_GET['del']))
{
    ...
    {
        $did=$_GET['did'];
        $delete=mysqli_query($dbcon,"delete from dep_info where depid='$did'");
        if($delete>0)
        {
            header("location:department.php");
        }
    ...
    {
        $cid=$_GET['cid'];
        $del1=mysqli_query($dbcon,"delete from student_data where crs='$cid'");
        $del2=mysqli_query($dbcon,"delete from dep_info where crsid='$cid'");
        $del3=mysqli_query($dbcon,"delete from crs_info where crsid='$cid'");
        if($del3>0)
        {
            header("location:department.php");
        }
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
							...
							<h1>
								Dashboard
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <h3 style="color: red">Programme Already Added</h3> 
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <h3 style="color: red">Department Already Added</h3> 
                ...
                <tr>
                    <td colspan="2"><center><b>UPDATE PROGRAMME</b></center></td>
                </tr>
                <tr>
                    <td>Programme Name</td>
                    <td><input type="text" name="cn1" value="<?php echo $_GET['cn'] ?>" class="form-control" required="required" /></td>
                </tr>
                <tr>
                ...
                <table class="table table-bordered table-condensed table-hover table-striped">
                <tr>
                    <td colspan="2"><a href="department.php" class="label label-danger pull-right">BACK</a>
                <center><b>ADD DEPARTMENT</b></center></td>
                </tr>
                <tr>
                    <td>Programme Name</td>
                    <td><input type="text" name="cn2" value="<?php echo $_GET['cn'] ?>" class="form-control" required="required" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td>Department</td>
            ...
            <table class="table table-bordered table-condensed table-hover table-striped">
                <tr>
                    <td colspan="2"><center><b>ADD PROGRAMME</b></center></td>
                </tr>
                <tr>
                    <td>Programme Name</td>
                ...
                <table class="table table-bordered table-condensed table-hover table-striped">
                     <tr>
                        <td colspan="4"><center><b>PROGRAMME DETAILS</b></center></td>
                    </tr>
                    <tr>
                        <td>#</td>
                        <td>Programme Name</td>
                    ...
                    <?php
                    $sel_crs=mysqli_query($dbcon,"select * from crs_info order by crs_nme asc");
                    if(mysqli_num_rows($sel_crs)>0)
                    {
                        $i=0;
                        while($rcrs=mysqli_fetch_row($sel_crs))
                        {
                            $i++;
                            ?>
                    <tr>
                        <td><?php echo $i ?></td>
                        <td><?php echo $rcrs[1] ?></td>
                        <td><a href="department.php?edit=2&cid=<?php echo $rcrs[0] ?>&cn=<?php echo $rcrs[1] ?>"><span class="fa fa-plus-circle" title="Add Department"></span></a> | 
                            <a href="department.php?edit=1&cid=<?php echo $rcrs[0] ?>&cn=<?php echo $rcrs[1] ?>"><span class="fa fa-edit" style="color: green" title="Edit Programme"></span></a> |
                            <a href="department.php?del=2&cid=<?php echo $rcrs[0] ?>"><span class="fa fa-trash" style="color: red;"></span></a>
                    ...
                    if(isset($_GET['z']))
                    {
                        ...
                        if($z=="2")
                        {
                            $sel_hod=mysqli_query($dbcon,"select * from staf_data where crs='".$_GET['crs']."' and dep='".$_GET['dep']."' and desig='1'");
                            if(mysqli_num_rows($sel_hod)>0)
                            {
                                ?>
                                                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                                                ...
                                                                <?php
                                                                $i=0;
                                                                while($rhod=mysqli_fetch_row($sel_hod))
                                                                {
                                                                    $i=1;
                                                                    ?>
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                    <td><?php echo $rhod[1] ?> (<?php echo $rhod[2] ?>)</td>
                                                                    <td><?php echo $rhod[7] ?></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
                    ...
                    <?php
                    $sel_hod=mysqli_query($dbcon,"select * from staf_data where crs='".$_GET['crs']."' and dep='".$_GET['dep']."'");
                            if(mysqli_num_rows($sel_hod)>0)
                            {
                                ?>
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped">
                    <tr>
                        <td colspan="4"><center><b>DEPARTMENT DETAILS</b></center></td>
                    </tr>
                    <tr>
                        <td>#</td>
                    ...
                    <?php
                    $sel_c1=mysqli_query($dbcon,"select * from crs_info order by crs_nme asc");
                    if(mysqli_num_rows($sel_c1)>0)
                    {
                        while($r_c1=  mysqli_fetch_row($sel_c1))
                        {
                            ?>
                            <tr>
                                <td colspan="4"><b><?php echo $r_c1[1] ?></b></td>
                            </tr>                    
                            <?php
                            $sel_d1=mysqli_query($dbcon,"select * from dep_info where crsid='$r_c1[0]'");
                            if(mysqli_num_rows($sel_d1)>0)
                            {
                                ...
                                while($rd1=mysqli_fetch_row($sel_d1))
                                {
                                  ...
                                  ?>
                                    <tr>
                                        <td><?php echo $x ?></td>
                                        <td><?php echo $rd1[2] ?></td>
                                        <td><a href="department.php?del=1&did=<?php echo $rd1[0] ?>"><span class="label label-danger"><span class="glyphicon glyphicon-trash"></span> Delete</span></a></td>
                                    </tr>
                            <?php                                    
                                }
                            }
                            else
                            {
                                ?>
                            <tr>
                                <td colspan="4"><i>No Department Found</i></td>
                            </tr>
                            <?php
                            }
                        }
