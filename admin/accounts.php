                                                        ...
                                                        <div class="col-lg-6">
                                                            <script>
                                                                function loaddata(x)
                                                                {
                                                                    ...
                                                                    xmlhttp.open("GET", "loadstf.php?q=" + x, true);
                                                                    xmlhttp.send();
                                                                }
                                                            </script>
                                                            <input type="text" onkeyup="loaddata(this.value)" class="form-control" placeholder="Search Staff or Student here" />
                                                            <script>
                                                            function resetstaff(x,i)
                                                            {
                                                                var xmlhttp = new XMLHttpRequest();
                                                                    xmlhttp.onreadystatechange = function() {
                                                                        if (this.readyState == 4 && this.status == 200) {
                                                                            document.getElementById("st"+i).innerHTML = this.responseText;
                                                                        }
                                                                    };
                                                                    xmlhttp.open("GET", "changestfpas.php?id=" + x, true);
                                                                    xmlhttp.send();
                                                            }
                                                            function resetstud(x,i)
                                                            {
                                                                var xmlhttp = new XMLHttpRequest();
                                                                    xmlhttp.onreadystatechange = function() {
                                                                        if (this.readyState == 4 && this.status == 200) {
                                                                            document.getElementById("stud"+i).innerHTML = this.responseText;
                                                                        }
                                                                    };
                                                                    xmlhttp.open("GET", "changestudpas.php?id=" + x, true);
                                                                    xmlhttp.send();
                                                            }
                                                            </script>
                                                            <div id="rslt"></div>
