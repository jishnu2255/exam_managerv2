...
if(isset($_POST['sub']))
{
    ...
    $vdt=$_POST['vdt'];
    $msg=$_POST['inf'];
    $ins=mysqli_query($dbcon,"INSERT INTO `notice_data`(`tit`, `pdt`, `edt`, `msg`, `pby`, `st`) VALUES ('$nt','$dt','$vdt','$msg','Admin','1')");
    if($ins>0)
    {
...
{
    $nid=$_GET['nid'];
    $del=mysqli_query($dbcon,"delete from notice_data where nid='$nid'");
    if($del>0)
    {
        header("location:notice.php");
    }
                                                    ...
                                                    <div class="col-xs-12">                                                       
                                                        <div class="col-lg-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-hover">
                                                                <tr>
                                                                    <td colspan="2">Title
                                                                        <input type="text" name="nt" class="form-control" required="" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Validity</td>
                                                                    <td><input type="date" name="vdt" class="form-control" required="" /></td>
                                                                </tr>
                                                                 
                                                                <tr>
                                                                    <td colspan="2">Information
                                                                        <textarea id="editor"  name="inf" class="form-control" required=""></textarea>
                                                                    </td>
                                                                </tr>
                                                                <script>
	initSample();
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center>
                                                                    <input type="submit" name="sub" value="POST NOW" class="btn btn-sm btn-success" />
                                                                </center> 
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <?php
                                                            $dt=date('Y-m-d');
                                                            $seln=mysqli_query($dbcon,"select * from notice_data where edt >='$dt'");
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div style="float: right;">
                                                                            Posted On : <?php echo date('d-M-Y', strtotime($rn[2])) ?><br />
                                                                            Posted By : <?php echo $rn[5] ?>
                                                                        </div><br /><br />
                                                                        <h4><?php echo $rn[1] ?></h4>
                                                                        <p style="text-align: justify;">
                                                                            <?php echo $rn[4] ?>
                                                                        </p>
                                                                        <a href="notice.php?nid=<?php echo $rn[0] ?>" class="label label-danger pull-right"><span class="fa fa-trash"></span> Delete</a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                }
