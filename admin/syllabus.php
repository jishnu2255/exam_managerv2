...
if(isset($_GET['did']))
{
    ...
    $t=$_GET['t'];
    $did=$_GET['did'];
    $del=mysqli_query($dbcon,"delete from syllabus_data where sylid='$did'");
    if($del>0)
    {
        header("location:syllabus.php?t=1&c=$crs&d=$dep&s=$sem");
    }
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /.breadcrumb -->
                                                ...
                                                <div style="padding: 5px; margin-left: 15px;"><b>ADD COURSES</b></div>
					</div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-striped">
                                                                <tr>
                                                                    <td colspan="2">
                                                                <center><b>CHOOSE PROGRAMME&DEPARTMENT TO ADD COURSE DETAILS</b></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Programme</td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><center><input type="submit" name="sub" value="ADD COURSES" class="btn btn-sm btn-danger" /></center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                            <?php
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            $i=0;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rd[5] ?></td>                                                                    
                                                                    <td>
                                                                        <a href="syllabus.php?did=<?php echo $rd[0] ?>&t=<?php echo $_GET['t'] ?>&c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>"><span class="fa fa-trash"></span></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                }
