...
if(isset($_POST['sub']))
{
    ...
    if($ins_stf>0)
    {
        ...
        {
            $ins_log=mysqli_query($dbcon,"INSERT INTO `user_log`(`id`, `uid`, `pwd`, `typ`, `st`) VALUES ('','$sid','$pas','STAF','1')");
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        <?php
                                                        $sel=mysqli_query($dbcon,"select * from exam_cmplnt order by id desc");
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                ?>
                                                                <img src="../invigilator/mpractice/<?php echo $rsel[6] ?>" class="img img-responsive" />
