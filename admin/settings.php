...
if($np==$rp)
{
$chk=mysqli_query($dbcon,"select * from user_log where uid='admin' and pwd='$cp'");
if(mysqli_num_rows($chk)>0)
{
    $up=mysqli_query($dbcon, "update user_log set pwd='$np' where uid='admin'");
    if($up>0)
    {
        header("location:settings.php?ch=1");    
    }
}
else
{
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <table class="table table-bordered table-responsive">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="password" name="rp" class="form-control" required="" /></td>
                                                            </tr>
                                                            <tr>                                    
                                                                <td colspan="2">
                                                            <center>
