...
if(isset($_POST['sub']))
{
    ...
    {
        $fn=$_FILES['up']['name'];
        $up=  move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\mpractice\\$fn");
    }
    else{
        $fn="nopic.png";
    }
    $inscmp=mysqli_query($dbcon,"INSERT INTO `exam_cmplnt`(`dt`, `tim`, `eid`, `rmnum`, `admnum`, `pic`, `descr`, `st`) VALUES ('".$_GET['dt']."','".$_GET['ti']."','".$_GET['eid']."','".$_GET['rm']."','$sid','$fn','$ds','1')");
    if($inscmp>0)
    {
        header("location:postdata.php?stid=".$_GET['stid']."&rm=".$_GET['rm']."&dt=".$_GET['dt']."&ti=".$_GET['ti']."&eid=".$_GET['eid']);
    }
}
?>
<!DOCTYPE html>
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">INVIGILATOR PORTAL</li>
						</ul><!-- /.breadcrumb -->
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-md-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover">
                                                                <tr>
                                                                    <td><center><b>COMPLAINT BOX</b></center></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><input type="text" name="sid" value="<?php echo $_GET['stid'] ?>" class="form-control" readonly="readonly" /></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <b>Description</b>
                                                                        <textarea name="ds" class="form-control" required="required"></textarea>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <input type="submit" name="sub" value="POST NOW" class="btn btn-sm btn-danger pull-right" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            $ti=$_GET['ti'];
                                                            $eid=$_GET['eid'];
                                                            $sel=mysqli_query($dbcon,"select * from exam_cmplnt where dt='$dt' and tim='$ti' and eid='$eid' and rmnum='$rm'");
                                                            if(mysqli_num_rows($sel)>0)
                                                            {
                                                                while($rsel=mysqli_fetch_row($sel))
                                                                {
                                                                    ?>
                                                            <div class="col-lg-6">
                                                                <?php 
                                                                $selsn=mysqli_query($dbcon,"select * from student_data where admnum='$rsel[5]'");
                                                                $rsn=mysqli_fetch_row($selsn);
                                                                echo "<center><b>".strtoupper($rsn[6])." ($rsel[5])</b></center>"; 
                                                                ?>
                                                                <img src="mpractice/<?php echo $rsel[6] ?>" class="img img-responsive" />
                                                                <?php echo ucwords($rsel[7]) ?>
                                                            </div>
                                                            <?php
                                                                }
                                                            }
