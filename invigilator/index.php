					...
					<div class="page-content">
						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <?php
                                                            $selst=mysqli_query($dbcon,"select * from staff_allocation where dt = '".date('Y-m-d')."' and stid like '%$uid%'");
                                                            ...
                                                            $i=0;
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i ?></td>
                                                                    <td><?php echo date("d-M-Y",strtotime($rst[3])) ?></td>
                                                                    <td><?php echo $rst[4] ?></td>
                                                                    <td><?php echo $rst[5] ?></td>
                                                                    <td><?php echo $rst[6] ?></td>
                                                                    <td>
                                                                        <a href="index.php?t=1&eid=<?php echo $rst[2] ?>&dt=<?php echo $rst[3] ?>&ti=<?php echo $rst[4] ?>&rm=<?php echo $rst[6] ?>"><span class="label label-danger"><span class="glyphicon glyphicon-user"></span> View Students</span></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                }
                                                            ...
                                                            if(isset($_GET['t']))
                                                            {
                                                                ...
                                                                $ti=$_GET['ti'];
                                                                $rm=$_GET['rm'];
                                                                $selst=mysqli_query($dbcon,"select * from room_assign where eid='$eid' and rumid='$rm' and dt='$dt' and tim='$ti'");
                                                                if(mysqli_num_rows($selst)>0)
                                                                {
                                                                    ?>
                                                            <table class="table table-bordered table-condensed table-hover">
                                                                <tr>
                                                                    <td colspan="5">
                                                                        <a href="index.php" class="label label-warning pull-right">BACK</a>
                                                                <center><b>STUDENT LIST</b></center></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>#</td>
                                                                    <td>Roll Number</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rst[6] ?></td>
                                                                    <td><?php echo $rst[4] ?></td>
                                                                    <td><a href="postdata.php?stid=<?php echo $rst[6] ?>&rm=<?php echo $_GET['rm'] ?>&dt=<?php echo $_GET['dt'] ?>&ti=<?php echo $_GET['ti'] ?>&eid=<?php echo $_GET['eid'] ?>"><span class="fa fa-chain"></span></a></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
